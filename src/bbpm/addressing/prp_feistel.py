...
def prp_offsets(
    ...
    seed_prp_base_tensor = torch.tensor([seed], dtype=torch.int64, device=device)
    seed_prp_base_tensor = (seed_prp_base_tensor ^ CONST_B) & MASK64
    ...
    h_tensor = (seed_prp_base ^ (h_tensor * LARGE_CONST)) & MASK64
